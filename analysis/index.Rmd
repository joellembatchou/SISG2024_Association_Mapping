...
The official SISG web page can be found [here](https://sisg.biosciences.gatech.edu/sisg-module-19/) (requires login) – course evaluations and certificates of completion are available via this page.
...
All the data sets used can be downloaded from the [Github repository](https://github.com/joellembatchou/SISG2024_Association_Mapping/tree/master/data).
These have also been upload on the [Box folder](https://gatech.box.com/s/l9rfqhs8v4o9j8bm9qg6conm4zax7rnp) for the class.
