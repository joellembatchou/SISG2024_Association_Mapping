...
3. By default, the 2-parameter model is used since the SNP is stored in the data as categorical. Contrast the parameter estimates, p-values and confidence intervals obtained between this model and using:
...
4. Provide a plot illustrating the relationship between sbp and the three genotypes at SNP3.
```{r, eval = FALSE}
...
5. Now redo the linear regression analysis of `sbp` from question 3 for the **additive model**, but this time adjust for `sex` and `bmi`. Do the results change?
